...
<body>
    ...
    <div>
      ...
      <a href="ChangePassword.jsp?name=<%=s[0]%>"> <img src="c.png" title="Change Password" class="ac"  ></a>
    </div>
        <h1><span class="blue"></span>Hello<span class="blue"></span> <span class="yellow">User</span></h1>
<h2 id="add">Your Products</h2>
		...
		<%
						...
						out.println("<tr>");
							...
							out.println("</td>");
                                               ...
                                               if(flag==0){
                                                   out.println("<script>document.getElementById('add').innerHTML=\"You haven't added any product\"</script>");
                                               }
                                                %>
