	...
	<tbody>
		<%
                                                     ...
                                                     int i=0;
                                                      ...
                                                      String s[]=request.getParameter("username").split("@");
                                                      //String s[]=m.getUsername().split("@");
                                                     
                                                      ps= DBConnection.getConnection(). prepareStatement("select * from "+s[0]);
						...
						out.println("<tr>");
							...
							out.println("</td>");
							out.println("<td>");
                                                                   out.println("<img src='icons8-add-32.png' title='Add to Cart' onclick=\"prom('"+rs.getString(1)+"'"+","+rs.getFloat(2)+","+rs.getFloat(3)+")\">");
                                                        out.println("</td>");
                                                out.println("</tr>");
                                                      }
                                                if(i==0){
                                                     out.println("<script>$(\"#ch\").html('No Products Added by this Seller')</script>");
                                                }
                                                %>
    ...
    --> 
     <script>
            function prom(st,a,b){
                var kg=prompt('Enter Quantity in kg');
                var ab=kg*b;
                if(a<kg)
                    alert('ERROR!!!!....Required Quantity > Available Quantity');
                else{
                $.post("Cart",{
